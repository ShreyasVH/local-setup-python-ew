...
INSERT INTO foreign_ins_template (content) VALUES ('Good morning, patients X of Y have not taken their medicine for two days in a row, they need to be called: %(patients).');
INSERT INTO foreign_ins_template (content) VALUES ('Good morning! Yesterday, %(marked) of %(total) patients texted their code. The following patients need to be followed up: %(patients)');
