INSERT INTO test_request (created_date, entity_id, previous_att, reason, status, subreason, updated_date, nikshay_source_id, client_id) VALUES ('UTC_DATE_TIME_PLUS_5_MINUTE', 35, false, 'Diagnosis', 4, '{"predominantSymptom":null,"predominantSymptomDuration":"","hcpVisits":"","diagnosisOfTB":""}', 'UTC_DATE_TIME_PLUS_5_MINUTE', null, (SELECT id FROM client WHERE name = 'Nikshay'));
